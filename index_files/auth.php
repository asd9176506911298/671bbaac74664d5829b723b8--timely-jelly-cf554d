...
if(linkfound==false){var div=document.createElement('div');div.id='error_ae151b18cea5a9a9aab2921427d494d4d7fbe0db';div.innerHTML='<a href="https://www.freevisitorcounters.com/en/home/countercode/hashid/?id=ae151b18cea5a9a9aab2921427d494d4d7fbe0db">Counter Error: Do not change the code. Click here to show the correct code!</a>';if(document.getElementById('counterimg')!=null){document.getElementById('counterimg').parentNode.insertBefore(div,document.getElementById('counterimg').nextSibling);}else{document.body.appendChild(div);}
